...
import { Search, Download, Eye, Plus, ShoppingCart, ShoppingBag } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        ...
        {(['all', 'today', 'custom', 'guest'].includes(activeTab)) && (
                      ...
                      <TableRow key={order.id}>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-sm">{order.vendor}</span>
                          </div>
                        </TableCell>
                        <TableCell className="hidden md:table-cell">{order.city}</TableCell>
